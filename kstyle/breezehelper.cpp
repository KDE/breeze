...
namespace Breeze
{
    ...
    void Helper::renderDecorationButton( QPainter* painter, const QRect& rect, const QColor& color, ButtonType buttonType, bool inverted, bool paintBackground, const QColor& backgroundColor ) const
    {
        ...
        if( paintBackground )
        {
            ...
            if ( decorationConfig()->buttonShape() ==  InternalSettings::EnumButtonShape::ShapeFullSizedRectangle || decorationConfig()->buttonShape() ==  InternalSettings::EnumButtonShape::ShapeSquare)
