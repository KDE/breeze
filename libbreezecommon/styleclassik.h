...
namespace Breeze
{
    ...
    class RenderStyleClassik18By18 : public RenderDecorationButtonIcon18By18
    {
        public:
             ...
             */
            RenderStyleClassik18By18(QPainter* painter, const QPen& pen, const bool notInTitlebar, const bool boldButtonIcons) : RenderDecorationButtonIcon18By18(painter, pen, notInTitlebar, boldButtonIcons){};
