...
namespace Breeze
{
    ...
    class RenderStyleOxygen18By18 : public RenderDecorationButtonIcon18By18
    {
        public:
             ...
             */
            RenderStyleOxygen18By18(const QSharedPointer<InternalSettings>& internalSettings, QPainter* painter, const bool notInTitlebar) : RenderDecorationButtonIcon18By18(internalSettings, painter, notInTitlebar){};
