...
namespace Breeze
{
    ...
    class RenderStyleKite18By18 : public RenderDecorationButtonIcon18By18
    {
        public:
             ...
             */
            RenderStyleKite18By18(QPainter* painter, const QPen& pen, const bool notInTitlebar, const bool boldButtonIcons) : RenderDecorationButtonIcon18By18(painter, pen, notInTitlebar, boldButtonIcons){};
