...
namespace Breeze
{
    ...
    class RenderStyleRedmond18By18 : public RenderDecorationButtonIcon18By18
    {
        public:
             ...
             */
            RenderStyleRedmond18By18(const QSharedPointer<InternalSettings>& internalSettings, QPainter* painter, const QPen& pen, const bool notInTitlebar) : RenderDecorationButtonIcon18By18(internalSettings, painter, pen, notInTitlebar){};
